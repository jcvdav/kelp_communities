...
```{r}
kelp <- read.csv(here("data", "raw_data", "Peces_KelpForest_2011-2013.csv"),
                 stringsAsFactors = F) %>% 
...
write.csv(indicators_2011_2013,
          file = here("docs", "community", "tables", "indicators_2011_2013.csv"),
          row.names = F)
...
ggsave(plot = index_2013,
       filename = here("docs", "community", "img", "latitudinal_indices_2011_2013.png"),
       width = 8,
       height = 4.5)
```
